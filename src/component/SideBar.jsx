        ...
        <>
            ...
            <div
                style={{
                    ...
                    width: "340px",
                    background:
                        "linear-gradient(180deg, #8b4513 0%, #654321 50%, #5d4e37 100%)",
                    color: "#f4f1e8",
                    padding: "40px 30px",
                    boxShadow:
                        "-6px 0 25px rgba(0, 0, 0, 0.6), inset 2px 0 4px rgba(255, 255, 255, 0.1)",
                    zIndex: 1000,
                    display: "flex",
            ...
            >
                ...
                <div
                    style={{
                        ...
                        height: "8px",
                        background:
                            "repeating-linear-gradient(90deg, #daa520 0px, #daa520 15px, #b8860b 15px, #b8860b 30px)"
                    }}
                ></div>
                ...
                <div
                    style={{
                        ...
                        height: "100%",
                        background:
                            "url('data:image/svg+xml;utf8,<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 100 100\"><defs><pattern id=\"grain\" patternUnits=\"userSpaceOnUse\" width=\"100\" height=\"100\"><circle cx=\"25\" cy=\"25\" r=\"1\" fill=\"%23f4f1e8\" opacity=\"0.03\"/><circle cx=\"75\" cy=\"75\" r=\"1\" fill=\"%23000000\" opacity=\"0.08\"/></pattern></defs><rect width=\"100%\" height=\"100%\" fill=\"url(%23grain)\"/></svg>') repeat",
                        pointerEvents: "none",
                        opacity: 0.3
                    }}
                ></div>
                ...
                >
                    ...
                    <button
                        ...
                        style={{
                            ...
                            cursor: "pointer",
                            boxShadow:
                                "inset 0 2px 4px rgba(255,255,255,0.3), 0 2px 8px rgba(0,0,0,0.4)",
                ...
                >
                    {[
                        ...
                        <a
                            ...
                            onMouseEnter={(e) => {
                                e.currentTarget.style.background =
                                    "linear-gradient(90deg, rgba(218, 165, 32, 0.5), rgba(184, 134, 11, 0.4))";
                                e.currentTarget.style.transform = "translateX(-5px)";
                                e.currentTarget.style.borderColor = "#daa520";
                                e.currentTarget.style.boxShadow =
                                    "inset 0 1px 2px rgba(255,255,255,0.2), 0 4px 8px rgba(218, 165, 32, 0.4)";
                            }}
                            onMouseLeave={(e) => {
                                e.currentTarget.style.background =
                                    index === 0
