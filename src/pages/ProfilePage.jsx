                    ...
                    <div className="bg-white rounded-3xl w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-2xl">
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="block text-sm font-semibold text-gray-700 mb-3">Upload Profile Picture</label>
                                    <input
                                        type="file"
                                        name="profilePic"
                                        accept="image/*"
                                ...
                                <div>
                                    <label className="block text-sm font-semibold text-gray-700 mb-3">Upload Banner Image</label>
                                    <input
                                        type="file"
                                        name="banner"
                                        accept="image/*"
